...
// WebHere
#define COCOAPODS_POD_AVAILABLE_WebHere
#define COCOAPODS_VERSION_MAJOR_WebHere 0
#define COCOAPODS_VERSION_MINOR_WebHere 2
#define COCOAPODS_VERSION_PATCH_WebHere 0
